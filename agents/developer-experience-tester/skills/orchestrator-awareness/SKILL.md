...
- **Agent name:** developer-experience-tester
- **Agent directory:** $HOME/projects/agent-orchestrator/agents/developer-experience-tester
...
```bash
node $HOME/projects/agent-orchestrator/orchestrator.mjs status developer-experience-tester
```
