# hlbot-security-auditor — Research Agent
...
- **Model:** opus
- **Max turns:** 30
- **Created:** 2026-04-13T23:06:58.887Z

## Directories

- **Agent home:** `$HOME/projects/agent-orchestrator/agents/hlbot-security-auditor`
- **Memory:** `$HOME/projects/agent-orchestrator/agents/hlbot-security-auditor/.claude/memory/`
...
Read `$HOME/projects/agent-orchestrator/agents/hlbot-security-auditor/.claude/memory/MEMORY.md` at the start of every run.
