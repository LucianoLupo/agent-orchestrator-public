...
- **Agent name:** hlbot-security-auditor
- **Agent directory:** $HOME/projects/agent-orchestrator/agents/hlbot-security-auditor
...
```bash
node $HOME/projects/agent-orchestrator/orchestrator.mjs status hlbot-security-auditor
```
