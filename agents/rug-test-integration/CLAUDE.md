# rug-test-integration — Research Agent
...
- **Model:** opus
- **Max turns:** 30
- **Created:** 2026-04-07T14:14:22.354Z

## Directories

- **Agent home:** `$HOME/projects/agent-orchestrator/agents/rug-test-integration`
- **Memory:** `$HOME/projects/agent-orchestrator/agents/rug-test-integration/.claude/memory/`
...
Read `$HOME/projects/agent-orchestrator/agents/rug-test-integration/.claude/memory/MEMORY.md` at the start of every run.
