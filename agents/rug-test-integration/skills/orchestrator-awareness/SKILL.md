...
- **Agent name:** rug-test-integration
- **Agent directory:** $HOME/projects/agent-orchestrator/agents/rug-test-integration
...
```bash
node $HOME/projects/agent-orchestrator/orchestrator.mjs status rug-test-integration
```
