# rug-code-deployment — Research Agent
...
- **Model:** opus
- **Max turns:** 25
- **Created:** 2026-04-06T19:34:09.412Z

## Directories

- **Agent home:** `$HOME/projects/agent-orchestrator/agents/rug-code-deployment`
- **Memory:** `$HOME/projects/agent-orchestrator/agents/rug-code-deployment/.claude/memory/`
...
Read `$HOME/projects/agent-orchestrator/agents/rug-code-deployment/.claude/memory/MEMORY.md` at the start of every run.
