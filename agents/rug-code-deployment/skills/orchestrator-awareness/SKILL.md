...
- **Agent name:** rug-code-deployment
- **Agent directory:** $HOME/projects/agent-orchestrator/agents/rug-code-deployment
...
```bash
node $HOME/projects/agent-orchestrator/orchestrator.mjs status rug-code-deployment
```
