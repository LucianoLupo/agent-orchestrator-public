...
- **Agent name:** rug-code-architecture
- **Agent directory:** $HOME/projects/agent-orchestrator/agents/rug-code-architecture
...
```bash
node $HOME/projects/agent-orchestrator/orchestrator.mjs status rug-code-architecture
```
