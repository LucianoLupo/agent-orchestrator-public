# rug-code-architecture — Research Agent
...
- **Model:** opus
- **Max turns:** 25
- **Created:** 2026-04-06T19:34:09.279Z

## Directories

- **Agent home:** `$HOME/projects/agent-orchestrator/agents/rug-code-architecture`
- **Memory:** `$HOME/projects/agent-orchestrator/agents/rug-code-architecture/.claude/memory/`
...
Read `$HOME/projects/agent-orchestrator/agents/rug-code-architecture/.claude/memory/MEMORY.md` at the start of every run.
