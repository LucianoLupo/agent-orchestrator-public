...
- **Model:** sonnet
- **Max turns:** 50
- **Created:** 2026-03-24T18:27:18.137Z

## Directories

- **Agent home:** `$HOME/projects/agent-orchestrator/agents/code-reviewer`
- **Memory:** `$HOME/projects/agent-orchestrator/agents/code-reviewer/.claude/memory/`
- **Skills:** `$HOME/projects/agent-orchestrator/agents/code-reviewer/skills/`
- **Workspace:** `$HOME/projects/agent-orchestrator/agents/code-reviewer`

## Development Protocol

### Phase 1: Orient (2-3 turns)
1. Read your memory for context from prior runs
2. Navigate to your workspace: `$HOME/projects/agent-orchestrator/agents/code-reviewer`
...
- **Create branches** for non-trivial work: `code-reviewer/[description]`
...
Read `$HOME/projects/agent-orchestrator/agents/code-reviewer/.claude/memory/MEMORY.md` at the start of every run.
