...
- **Agent name:** web3-accuracy-checker
- **Agent directory:** $HOME/projects/agent-orchestrator/agents/web3-accuracy-checker
...
```bash
node $HOME/projects/agent-orchestrator/orchestrator.mjs status web3-accuracy-checker
```
