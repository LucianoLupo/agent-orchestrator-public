...
- **Agent name:** rug-test-analysis
- **Agent directory:** $HOME/projects/agent-orchestrator/agents/rug-test-analysis
...
```bash
node $HOME/projects/agent-orchestrator/orchestrator.mjs status rug-test-analysis
```
