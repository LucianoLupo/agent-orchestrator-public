# rug-test-analysis — Research Agent
...
- **Model:** opus
- **Max turns:** 30
- **Created:** 2026-04-07T14:14:22.397Z

## Directories

- **Agent home:** `$HOME/projects/agent-orchestrator/agents/rug-test-analysis`
- **Memory:** `$HOME/projects/agent-orchestrator/agents/rug-test-analysis/.claude/memory/`
...
Read `$HOME/projects/agent-orchestrator/agents/rug-test-analysis/.claude/memory/MEMORY.md` at the start of every run.
