...
- **Agent name:** rug-scanner-fixer
- **Agent directory:** $HOME/projects/agent-orchestrator/agents/rug-scanner-fixer
...
```bash
node $HOME/projects/agent-orchestrator/orchestrator.mjs status rug-scanner-fixer
```
