...
- **Agent name:** rug-code-security
- **Agent directory:** $HOME/projects/agent-orchestrator/agents/rug-code-security
...
```bash
node $HOME/projects/agent-orchestrator/orchestrator.mjs status rug-code-security
```
