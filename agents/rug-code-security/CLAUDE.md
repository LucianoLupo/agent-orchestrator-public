# rug-code-security — Research Agent
...
- **Model:** opus
- **Max turns:** 25
- **Created:** 2026-04-06T19:34:09.232Z

## Directories

- **Agent home:** `$HOME/projects/agent-orchestrator/agents/rug-code-security`
- **Memory:** `$HOME/projects/agent-orchestrator/agents/rug-code-security/.claude/memory/`
...
Read `$HOME/projects/agent-orchestrator/agents/rug-code-security/.claude/memory/MEMORY.md` at the start of every run.
