# rug-test-plan-quality — Research Agent
...
- **Model:** opus
- **Max turns:** 25
- **Created:** 2026-04-07T14:25:37.670Z

## Directories

- **Agent home:** `$HOME/projects/agent-orchestrator/agents/rug-test-plan-quality`
- **Memory:** `$HOME/projects/agent-orchestrator/agents/rug-test-plan-quality/.claude/memory/`
...
Read `$HOME/projects/agent-orchestrator/agents/rug-test-plan-quality/.claude/memory/MEMORY.md` at the start of every run.
