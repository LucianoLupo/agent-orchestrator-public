...
- **Agent name:** rug-test-plan-quality
- **Agent directory:** $HOME/projects/agent-orchestrator/agents/rug-test-plan-quality
...
```bash
node $HOME/projects/agent-orchestrator/orchestrator.mjs status rug-test-plan-quality
```
