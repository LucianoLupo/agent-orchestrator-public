...
- **Agent name:** solana-migration-auditor
- **Agent directory:** $HOME/projects/agent-orchestrator/agents/solana-migration-auditor
...
```bash
node $HOME/projects/agent-orchestrator/orchestrator.mjs status solana-migration-auditor
```
