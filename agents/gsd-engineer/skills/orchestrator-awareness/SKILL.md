...
- **Agent name:** gsd-engineer
- **Agent directory:** $HOME/projects/agent-orchestrator/agents/gsd-engineer
...
```bash
node $HOME/projects/agent-orchestrator/orchestrator.mjs status gsd-engineer
```
