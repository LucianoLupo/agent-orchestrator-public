# hlbot-performance-auditor — Research Agent
...
- **Model:** opus
- **Max turns:** 30
- **Created:** 2026-04-13T23:07:01.870Z

## Directories

- **Agent home:** `$HOME/projects/agent-orchestrator/agents/hlbot-performance-auditor`
- **Memory:** `$HOME/projects/agent-orchestrator/agents/hlbot-performance-auditor/.claude/memory/`
...
**Date:** [ISO date]
**Agent:** hlbot-performance-auditor
...
Read `$HOME/projects/agent-orchestrator/agents/hlbot-performance-auditor/.claude/memory/MEMORY.md` at the start of every run.
