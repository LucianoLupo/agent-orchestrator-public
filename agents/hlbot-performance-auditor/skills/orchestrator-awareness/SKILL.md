...
- **Agent name:** hlbot-performance-auditor
- **Agent directory:** $HOME/projects/agent-orchestrator/agents/hlbot-performance-auditor
...
```bash
node $HOME/projects/agent-orchestrator/orchestrator.mjs status hlbot-performance-auditor
```
