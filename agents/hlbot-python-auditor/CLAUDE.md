# hlbot-python-auditor — Research Agent
...
- **Model:** opus
- **Max turns:** 30
- **Created:** 2026-04-13T23:07:14.452Z

## Directories

- **Agent home:** `$HOME/projects/agent-orchestrator/agents/hlbot-python-auditor`
- **Memory:** `$HOME/projects/agent-orchestrator/agents/hlbot-python-auditor/.claude/memory/`
...
Read `$HOME/projects/agent-orchestrator/agents/hlbot-python-auditor/.claude/memory/MEMORY.md` at the start of every run.
