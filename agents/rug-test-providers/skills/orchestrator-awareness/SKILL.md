...
- **Agent name:** rug-test-providers
- **Agent directory:** $HOME/projects/agent-orchestrator/agents/rug-test-providers
...
```bash
node $HOME/projects/agent-orchestrator/orchestrator.mjs status rug-test-providers
```
