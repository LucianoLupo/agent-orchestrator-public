# rug-test-providers — Research Agent
...
- **Model:** opus
- **Max turns:** 30
- **Created:** 2026-04-07T14:14:22.440Z

## Directories

- **Agent home:** `$HOME/projects/agent-orchestrator/agents/rug-test-providers`
- **Memory:** `$HOME/projects/agent-orchestrator/agents/rug-test-providers/.claude/memory/`
...
Read `$HOME/projects/agent-orchestrator/agents/rug-test-providers/.claude/memory/MEMORY.md` at the start of every run.
