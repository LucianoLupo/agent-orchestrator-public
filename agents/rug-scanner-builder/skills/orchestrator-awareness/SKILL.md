...
- **Agent name:** rug-scanner-builder
- **Agent directory:** $HOME/projects/agent-orchestrator/agents/rug-scanner-builder
...
```bash
node $HOME/projects/agent-orchestrator/orchestrator.mjs status rug-scanner-builder
```
