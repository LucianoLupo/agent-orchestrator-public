# frontend-ux-auditor — Developer Agent
...
- **Model:** opus
- **Max turns:** 30
- **Created:** 2026-03-31T23:10:23.513Z

## Directories

- **Agent home:** `$HOME/projects/agent-orchestrator/agents/frontend-ux-auditor`
- **Memory:** `$HOME/projects/agent-orchestrator/agents/frontend-ux-auditor/.claude/memory/`
- **Skills:** `$HOME/projects/agent-orchestrator/agents/frontend-ux-auditor/skills/`
...
- **Create branches** for non-trivial work: `frontend-ux-auditor/[description]`
...
Read `$HOME/projects/agent-orchestrator/agents/frontend-ux-auditor/.claude/memory/MEMORY.md` at the start of every run.
