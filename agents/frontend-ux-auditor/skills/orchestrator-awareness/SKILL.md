...
- **Agent name:** frontend-ux-auditor
- **Agent directory:** $HOME/projects/agent-orchestrator/agents/frontend-ux-auditor
...
```bash
node $HOME/projects/agent-orchestrator/orchestrator.mjs status frontend-ux-auditor
```
