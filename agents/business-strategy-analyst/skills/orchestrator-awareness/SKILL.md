...
- **Agent name:** business-strategy-analyst
- **Agent directory:** $HOME/projects/agent-orchestrator/agents/business-strategy-analyst
...
```bash
node $HOME/projects/agent-orchestrator/orchestrator.mjs status business-strategy-analyst
```
