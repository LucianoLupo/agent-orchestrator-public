...
- **Agent name:** hlbot-quality-auditor
- **Agent directory:** $HOME/projects/agent-orchestrator/agents/hlbot-quality-auditor
...
```bash
node $HOME/projects/agent-orchestrator/orchestrator.mjs status hlbot-quality-auditor
```
