# hlbot-quality-auditor — Research Agent
...
- **Model:** opus
- **Max turns:** 30
- **Created:** 2026-04-13T23:07:08.718Z

## Directories

- **Agent home:** `$HOME/projects/agent-orchestrator/agents/hlbot-quality-auditor`
- **Memory:** `$HOME/projects/agent-orchestrator/agents/hlbot-quality-auditor/.claude/memory/`
...
Read `$HOME/projects/agent-orchestrator/agents/hlbot-quality-auditor/.claude/memory/MEMORY.md` at the start of every run.
