...
- **Agent name:** donchian-alts-engineer
- **Agent directory:** $HOME/projects/agent-orchestrator/agents/donchian-alts-engineer
...
```bash
node $HOME/projects/agent-orchestrator/orchestrator.mjs status donchian-alts-engineer
```
