...
- **Agent name:** test-worker-2
- **Agent directory:** $HOME/projects/agent-orchestrator/agents/test-worker-2
...
```bash
node $HOME/projects/agent-orchestrator/orchestrator.mjs status test-worker-2
```
