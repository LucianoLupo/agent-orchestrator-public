...
- **Model:** haiku
- **Max turns:** 3
- **Created:** 2026-03-30T14:03:54.028Z

## Directories

- **Agent home:** `$HOME/projects/agent-orchestrator/agents/test-worker-2`
- **Memory:** `$HOME/projects/agent-orchestrator/agents/test-worker-2/.claude/memory/`
- **Skills:** `$HOME/projects/agent-orchestrator/agents/test-worker-2/skills/`
- **Workspace:** `$HOME/projects/agent-orchestrator/agents/test-worker-2`

## Development Protocol

### Phase 1: Orient (2-3 turns)
1. Read your memory for context from prior runs
2. Navigate to your workspace: `$HOME/projects/agent-orchestrator/agents/test-worker-2`
...
- **Create branches** for non-trivial work: `test-worker-2/[description]`
...
Read `$HOME/projects/agent-orchestrator/agents/test-worker-2/.claude/memory/MEMORY.md` at the start of every run.
