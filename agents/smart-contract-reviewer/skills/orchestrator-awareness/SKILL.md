...
- **Agent name:** smart-contract-reviewer
- **Agent directory:** $HOME/projects/agent-orchestrator/agents/smart-contract-reviewer
...
```bash
node $HOME/projects/agent-orchestrator/orchestrator.mjs status smart-contract-reviewer
```
