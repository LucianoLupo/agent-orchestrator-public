...
- **Agent name:** rug-code-correctness
- **Agent directory:** $HOME/projects/agent-orchestrator/agents/rug-code-correctness
...
```bash
node $HOME/projects/agent-orchestrator/orchestrator.mjs status rug-code-correctness
```
