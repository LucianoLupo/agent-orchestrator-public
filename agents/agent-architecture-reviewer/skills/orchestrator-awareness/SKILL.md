...
- **Agent name:** agent-architecture-reviewer
- **Agent directory:** $HOME/projects/agent-orchestrator/agents/agent-architecture-reviewer
...
```bash
node $HOME/projects/agent-orchestrator/orchestrator.mjs status agent-architecture-reviewer
```
