...
- **Agent name:** stitch-designer-v2
- **Agent directory:** $HOME/projects/agent-orchestrator/agents/stitch-designer-v2
...
```bash
node $HOME/projects/agent-orchestrator/orchestrator.mjs status stitch-designer-v2
```
