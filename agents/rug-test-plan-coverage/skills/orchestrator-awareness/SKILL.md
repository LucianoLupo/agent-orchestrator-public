...
- **Agent name:** rug-test-plan-coverage
- **Agent directory:** $HOME/projects/agent-orchestrator/agents/rug-test-plan-coverage
...
```bash
node $HOME/projects/agent-orchestrator/orchestrator.mjs status rug-test-plan-coverage
```
