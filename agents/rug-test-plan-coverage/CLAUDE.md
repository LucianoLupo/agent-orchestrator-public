# rug-test-plan-coverage — Research Agent
...
- **Model:** opus
- **Max turns:** 25
- **Created:** 2026-04-07T14:25:37.626Z

## Directories

- **Agent home:** `$HOME/projects/agent-orchestrator/agents/rug-test-plan-coverage`
- **Memory:** `$HOME/projects/agent-orchestrator/agents/rug-test-plan-coverage/.claude/memory/`
...
Read `$HOME/projects/agent-orchestrator/agents/rug-test-plan-coverage/.claude/memory/MEMORY.md` at the start of every run.
