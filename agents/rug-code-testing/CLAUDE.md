# rug-code-testing — Research Agent
...
- **Model:** opus
- **Max turns:** 25
- **Created:** 2026-04-06T19:34:09.366Z

## Directories

- **Agent home:** `$HOME/projects/agent-orchestrator/agents/rug-code-testing`
- **Memory:** `$HOME/projects/agent-orchestrator/agents/rug-code-testing/.claude/memory/`
...
Read `$HOME/projects/agent-orchestrator/agents/rug-code-testing/.claude/memory/MEMORY.md` at the start of every run.
