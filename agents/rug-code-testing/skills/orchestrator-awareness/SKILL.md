...
- **Agent name:** rug-code-testing
- **Agent directory:** $HOME/projects/agent-orchestrator/agents/rug-code-testing
...
```bash
node $HOME/projects/agent-orchestrator/orchestrator.mjs status rug-code-testing
```
